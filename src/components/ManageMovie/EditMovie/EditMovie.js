...
class EditMovie extends Component {
  ...
  componentDidMount () {
    this.setState({ genre: this.value })
  }
  ...
  submitData = async (values) => {
    ...
    if (genre.length > 0) {
      ...
      await this.props.editMovie(this.props.auth.token, this.props.movie.details.id, movieName, mapGenre, file, releaseDate, category, duration, director, casts, description)
  ...
  render () {
    return (
      ...
      <Formik
        initialValues={{
          movieName: this.props.movie.details.name,
          duration: this.props.movie.details.duration,
          director: this.props.movie.details.directed,
          casts: this.props.movie.details.casts,
          category: this.props.movie.details.category,
          description: this.props.movie.details.description,
          releaseDate: this.props.movie.details.releaseDate
        }}
                ...
                <div className="card-movies d-flex align-items-center justify-content-center">
                  <label className="upload-file">
                    ...
                    <div className="image-file">
                      <img src={this.state.imgPreview !== null ? this.state.imgPreview : this.props.movie.details.image ? `${API_URL}uploads/movies/${this.props.movie.details.image}` : uploadHere} alt="movie" />
                    </div>
                  </label>
                </div>
                </Col>
